  ...
  return (
    <>
      <main className="dashboard_landing_body">
        <section
          ref={menuRef}
          className="dashboard_landing_menu_container"
        ...
        >
          ...
          <article className="dashboard_landing_menu_items_container">
            <NavLink
              to="/dashboard"
              className={({ isActive }) =>
                isActive ? "dashboard_menu_active" : "dashboard_menu_notactive"
              }
            >
              <MdDashboard />
              Dashboard
            ...
            <div
              className="dashboard_landing_menu_logout_container"
              onClick={logout}
            >
              <MdLogout />
              Logout
          ...
          <article className="dashboard_landing_header_container">
            <div className="dashboard_landing_header_left_container">
              ...
              {showMenu ? (
                <IoClose
                  onClick={() => setShowMenu(false)}
                  className="dashboard_header_menu_icon"
                />
              ) : (
                <IoMenu
