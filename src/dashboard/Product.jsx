  ...
  useEffect(()=>{
    const getAllProducts = async ()=>{
      try{
        ...
        localStorage.setItem("message", JSON.stringify({type: "error", value: "There is no available product"})) :
        localStorage.setItem("message", JSON.stringify({type: "success", value: "Products retrieved successfully"}))
