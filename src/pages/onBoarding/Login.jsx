  ...
  async function login(e) {
    ...
    if (!values.email) {
      ...
      localStorage.setItem(
        "message",
        JSON.stringify({ type: "error", value: "email is required" })
      );
    } else if (!values.password) {
      setShowMessage(!showMessage);
      localStorage.setItem(
        "message",
        JSON.stringify({ type: "error", value: "password is required" })
      );
    } else {
      try {
        setLoading(true);
        const url =
          "https://reborn-necessary-clothing-backend.onrender.com/api/auth/login";
    ...
    <>
      ...
      <main className="onboarding_body">
        <form onSubmit={login} className="onboarding_container">
          <article
            className="onboarding_logo_container"
            onClick={() => navigate("/")}
          >
          ...
          <article className="onboarding_input_body">
            ...
            <div className="onboarding_input_container">
              ...
              />
              <div
                className="password_eye_container"
          ...
          <button type="submit">
            {loading ? <LiaSpinnerSolid className="spinner" /> : "Login"}
          </button>
